...
@section('content')
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">{{ $tour_package->name }}</h1>
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="/admin/tour-packages" class="btn btn-sm btn-secondary ms-2">Kembali</a>
                <a href="/admin/tour-packages/{{ $tour_package->slug }}/edit" class="btn btn-sm btn-warning ms-2">Ubah</a>
            ...
            <div class="col-lg-6">
                <div id="carouselGalleryImage" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-indicators">
                        @if ($tour_package->tour_package_images->count() > 1)
                            <button type="button" data-bs-target="#carouselGalleryImage" data-bs-slide-to="0"
                                class="active" aria-current="true" aria-label="Slide 1"></button>
                            @foreach ($tour_package->tour_package_images->skip(1) as $image)
